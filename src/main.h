...
static const int64_t nMaxClockDrift = 0.5 * 60 * 60;        // two hours
...
public:
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // SuperTurbostake: get transaction coin age
...
public:
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // SuperTurbostake: calculate total coin age spent in block
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("049a06139d585d0ec756bd5ee302d78704614e720d9771dcf921fa36980940028329ee8516eb877a076ea850901cad160aba106fe10b0edc8e7e3a272ff3b200f4")))
